package top.huangt.algorithm.algorithm.classical.test5_max_feed;

import java.util.Arrays;

/**
 * @author ht
 * @date 2019-05-13 11:22
 * 有趣的 “切蛋糕“ 问题
 * 公众号文章链接：https://mp.weixin.qq.com/s/reTcC_XO2ArDattFqeQ0oA
 */
public class MaxFeed {
    ...
    static boolean canFeed(int[] mouths, int mouthIndex, int sum) {
        if (mouthIndex <= 0) {
            //递归边界
            return true;
        }
    ...
    static int findMaxFeed(int[] cakes, int[] mouths) {
        //蛋糕升序排列，并把0下标空出
